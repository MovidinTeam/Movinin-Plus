...
const PAYPAL_API = env.PAYPAL_SANDBOX ? 'https://api-m.sandbox.paypal.com' // PayPal sandbox host (for testing)
...
export const createOrder = async (bookingId, amount, currency, name, description, countryCode) => {
