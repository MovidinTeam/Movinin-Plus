...
import routeNames from "../config/propertyRoutes.config.js";
...
routes.route(routeNames.uploadImage).post([authJwt.verifyToken, authJwt.authAgency, multer({
  storage: multer.memoryStorage()
}).single('image')], propertyController.uploadImage);
