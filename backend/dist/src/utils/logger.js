 ...
 */
export const info = (message, obj) => log('info', message, obj);
/**
 ...
 * @param {*} [obj] - Optional additional data.
 */
export const warn = (message, obj) => log('warn', message, obj);
/**
 ...
 */
export const error = (message, obj) => log('error', message, obj);
/**
 * Enables all logging.
 */
